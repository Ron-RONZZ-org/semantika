...
DEFAULT_TURN1 = (
    ...
    "### Nodes\n"
    "3. Templates may reference fixed nodes (not parameters) in their "
    "triple patterns. For example, ``{subject} rdf:type Scientist`` references a "
    "``Scientist`` node; ``{subject} rs:worksAt Lab`` references a ``Lab`` node. "
